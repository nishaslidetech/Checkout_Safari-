...
public class HomePage extends BaseClass {
	...
	public void click_on_the_pagibation_and_check_the_console_error_for_the_two_pages_only() throws Throwable {
		 ...
		 * xpath("//div[3]//div[1]//div[1]//div//a//img[@alt = 'Next']"));
		 * nextButton.click();
		 * 
		 * Thread.sleep(3000); // print console error checkConsoleError();
		 * 
		 * } else
		 * 
		 * { break; } while (true); } else { System.out.println("No pagination exists");
		 * }
		 */
