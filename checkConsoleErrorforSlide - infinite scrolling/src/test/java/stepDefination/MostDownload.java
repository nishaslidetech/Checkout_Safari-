...
public class MostDownload extends BaseClass {
	...
	public void click_on_the_pagination_and_check_the_console_errorfor_two_pages_only() throws Throwable {
		 ...
		 * driver.findElements(By.xpath("//div[3]//div[1]//div[1]//div//a"));
		 * 
		 ...
		 * xpath("//div[3]//div[1]//div[1]//div//a//img[@alt = 'Next']")).isEmpty()) {
		 * 
	...
	public void click_on_the_view_page_and_check_the_console_error() throws Throwable {
		...
		/*
		 * selectDropdown =
		 * wait.until(ExpectedConditions.elementToBeClickable(By.id("dk1-combobox")));
		 * js.executeScript("arguments[0].scrollIntoView();", selectDropdown);
		 * selectDropdown.click();
		 * 
		 * // check console error for the 120 pages viewPerPage =
		 * wait.until(ExpectedConditions.elementToBeClickable(By.
		 * xpath("//ul[@id = 'dk1-listbox']//li[2]")));
		 * js.executeScript("arguments[0].scrollIntoView();", viewPerPage);
		 * viewPerPage.click(); Thread.sleep(2000); // print console error
		 * checkConsoleError();
		 * 
		 * selectDropdown =
		 * wait.until(ExpectedConditions.elementToBeClickable(By.id("dk1-combobox")));
		 ...
		 * selectDropdown.click();
		 * 
		 * // check console error for the 180 pages viewPerPage =
		 * wait.until(ExpectedConditions.elementToBeClickable(By.
		 * xpath("//ul[@id = 'dk1-listbox']//li[3]")));
		 * js.executeScript("arguments[0].scrollIntoView();", viewPerPage);
		 * viewPerPage.click(); Thread.sleep(2000); // print console error
		 * checkConsoleError();
		 */
