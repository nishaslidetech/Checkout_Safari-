...
public class SliPage extends BaseClass {
	...
	public void enter_data_in_search_field_and_cehck_the_console_error() throws Throwable {
		...
		WebElement hr_Report = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//a[@data-tb-sid='sts_suggestion-term-link']")));
		hr_Report.click();
		Thread.sleep(3000);
		checkConsoleError();
	...
	public void click_on_pagination_number_and_check_the_console_error_for_two_page_only_for_sli() throws Throwable {
		 ...
		 * 
		 * // click on pagination link for (int i = 1; i < sizeofPagination.size();) {
		 * 
		 * if (!driver.findElements(By.
		 * xpath("//div[3]//div[1]//div[1]//div//a//img[@alt = 'Next']")).isEmpty()) {
		 * 
		 * WebElement nextButton = driver .findElement(By.
		 * xpath("//div[3]//div[1]//div[1]//div[3]//ul[1]//li//img[@alt = 'Next']"));
		 * nextButton.click();
		 * 
		 * Thread.sleep(3000); checkConsoleError();
		 * 
		 * } else
		 * 
		 * { break; }
